/**
 * @file port_keypad.c
 * @brief Portable functions to interact with the keypad FSM library.
...
/**
 * @brief Array containingg every possible char.
 * 
 */
...
/**
 * @brief List of statuses of the different pins.
 * 
 */
const uint32_t clo_state[4]={
						(GPIO_BSRR_BR4|GPIO_BSRR_BS5|GPIO_BSRR_BS6|GPIO_BSRR_BS7),
